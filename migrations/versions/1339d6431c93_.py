...
Revision ID: 1339d6431c93
Revises: fd7d1bcc932d
Create Date: 2020-07-18 09:49:35.637396
...
revision = '1339d6431c93'
down_revision = 'fd7d1bcc932d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Artist', sa.Column('upcoming_shos_count', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('Artist', 'upcoming_shos_count')
